      ...
      <main className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center p-4">
          <div className="text-center card rounded-2xl p-10 max-w-sm">
            ...
            <p className="text-sm text-[hsl(var(--muted-foreground))] mb-6">Bạn cần đăng nhập để xem tin nhắn.</p>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <div className="mb-8">
            <h1 className="text-3xl font-bold flex items-center gap-3">
              <MessageCircle size={28} className="text-[hsl(var(--primary))]" /> Tin nhắn
            </h1>
            <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">Trao đổi với người đăng về món đồ</p>
          </div>
          ...
          {myConversations.length === 0 ? (
            <div className="card rounded-2xl p-12 text-center">
              ...
              <p className="text-sm text-[hsl(var(--muted-foreground))] mb-5">Khi bạn nhắn tin với người đăng món đồ, hội thoại sẽ hiển thị ở đây.</p>
            ...
            <div className="space-y-2">
              {myConversations.map(conv => {
                ...
                return (
                  ...
                  >
                    <div className="h-12 w-12 rounded-full bg-[hsl(var(--primary)/0.1)] flex items-center justify-center font-bold text-[hsl(var(--primary))] shrink-0">
                      {otherName.charAt(0)}
                    </div>
                    <div className="flex-grow min-w-0">
                      ...
                      <p className="text-xs text-[hsl(var(--muted-foreground))] truncate">
                        {conv.itemTitle && <>Về: <span className="font-medium text-[hsl(var(--foreground))]">{conv.itemTitle}</span> • </>}
                        {conv.lastMessage || 'Nhắn tin...'}
                      </p>
                    </div>
                    {conv.unread > 0 && (
                      <div className="h-6 w-6 rounded-full bg-[hsl(var(--primary))] text-white text-xs font-bold flex items-center justify-center">
                        {conv.unread}
                      </div>
                    )}
                    <ArrowRight size={18} className="text-[hsl(var(--muted-foreground))] shrink-0" />
                  </Link>
                );
              })}
            </div>
