    ...
    <div className="card rounded-2xl overflow-hidden flex flex-col group relative">
      <Link href={`/detail/${item.id}`} className="flex-grow">
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <p className="text-sm text-[var(--muted-foreground)] mb-4 line-clamp-2 leading-relaxed">{item.description}</p>
      ...
      <main className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center p-4">
          <div className="auth-gate">
            ...
            <p className="text-sm text-[var(--muted-foreground)] mb-6">Bạn cần đăng nhập để xem danh sách yêu thích.</p>
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow pt-28 pb-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-8">
            <Link href="/items" className="inline-flex items-center gap-1.5 text-sm text-[var(--muted-foreground)] hover:text-[var(--foreground)] font-medium mb-4 transition-colors">
              <ArrowLeft size={16} /> Quay lại khám phá
            </Link>
            <h1 className="text-3xl font-bold flex items-center gap-3">
              <Heart size={28} className="text-red-500" /> Món đồ yêu thích
            </h1>
            <p className="text-sm text-[var(--muted-foreground)] mt-1">Những món đồ bạn đã lưu lại</p>
          </div>
          ...
          {favoriteItems.length > 0 ? (
            ...
            <div className="empty-state">
              ...
              <p className="text-sm text-[var(--muted-foreground)] mb-5">Nhấn vào trái tim trên món đồ để lưu lại.</p>
