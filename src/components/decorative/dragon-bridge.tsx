  ...
  return (
    <div className={`pointer-events-none select-none ${className}`}>
      ...
      >
        ...
        />
        {/* Chân rồng */}
        <line x1="120" y1="105" x2="115" y2="135" stroke="color-mix(in oklch, var(--primary) 8%, transparent)" strokeWidth="2" />
        <line x1="240" y1="65" x2="245" y2="95" stroke="color-mix(in oklch, var(--primary) 8%, transparent)" strokeWidth="2" />
        <line x1="360" y1="35" x2="355" y2="65" stroke="color-mix(in oklch, var(--primary) 8%, transparent)" strokeWidth="2" />
      </svg>
    </div>
  );
}
