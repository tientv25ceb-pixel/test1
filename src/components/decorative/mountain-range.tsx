    ...
    <div className={`pointer-events-none select-none ${className}`}>
      ...
      >
        ...
        <path
          ...
          fill="color-mix(in oklch, oklch(0.55 0.20 255) 3%, transparent)"
        />
        {/* Núi gần */}
        <path
          d="M0,120 L80,65 L150,85 L220,50 L290,75 L370,45 L440,70 L510,55 L600,70 L600,120 Z"
          fill="color-mix(in oklch, oklch(0.55 0.20 145) 3%, transparent)"
        />
        {/* Núi trung tâm */}
        <path
          d="M50,120 L150,55 L220,80 L300,40 L380,70 L460,50 L550,75 L600,85 L600,120 Z"
          fill="color-mix(in oklch, oklch(0.55 0.20 255) 2.5%, transparent)"
        />
      </svg>
    </div>
  );
